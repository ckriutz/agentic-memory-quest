"""Mem0 agent backed by Azure Cosmos DB for NoSQL (Cosmos Edition)."""

from __future__ import annotations
from typing import Any
from agent_framework import ChatAgent
from tools import mem0_cosmos_tool
...
class Mem0CosmosAgent:

    def __init__(self, client: Any) -> None:
        memoryprovider = mem0_cosmos_tool.Mem0CosmosTool()
        ...
        print("Mem0 Cosmos Agent created successfully")
