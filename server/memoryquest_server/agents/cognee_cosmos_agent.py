"""Cognee agent backed by Azure Cosmos DB for NoSQL (Cosmos Edition)."""

from __future__ import annotations
from typing import Any
from agent_framework import ChatAgent
from tools import cognee_cosmos_memory_tool
...
class CogneeCosmosAgent:

    def __init__(self, client: Any) -> None:
        memoryprovider = cognee_cosmos_memory_tool.CogneeCosmosMemoryTool()
        ...
        print("Cognee Cosmos Agent created successfully")
